...
android {
    namespace = "com.sladkaya.sensor.sibionics.algorithm"
    compileSdk = 37
...
val verifyNativeBinaries by tasks.registering {
    group = "verification"
    description = "Verifies the pinned native algorithm binaries before building."

    val manifestFile = layout.projectDirectory.file("src/main/resources/native-binaries.sha256")
